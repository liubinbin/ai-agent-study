...
小助理原来只是自己拿到任务解决问题，现在他的头大了，现在事情多的做不完，而且新员工也不能闲着，得让他也干活。
在这种情况下，小助理逐渐学会了分配任务。
...
具体文件位于 /backend/packages/harness/deerflow/tools/builtings/task_tool.py。

## subagent 执行
让我关注 /backend/packages/harness/deerflow/tools/builtings/task_tool.py 文件
...
_execution_pool 提交一个执行方法，方法内容就是往 _execution_pool 提交 feture，然后带超时得获取结果。
